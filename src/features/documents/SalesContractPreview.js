        ...
        <Grid className={classes.root}>
            <Grid container direction="column">
                ...
                <Grid container className={classes.title}>
                    <LongBox label1={"Origin of product产地"} value1={sellerAdd.country.id} label2={"Paymt Term付款条件"} value2={termsOfPayment} />
                    ...
                    <LongBox label1={"Shipment Time装运期"} value1={timeOfShipment} label2={"Insurance保险"} value2={insurance} />
                </Grid>
                <Grid item container xs={12} direction="column" className={classes.title}>
                    <Typography variant="caption">
                ...
                <DocumentFooter label1={"The Seller/卖方"} text1={sellerAdd.name} label2={"The Buyer/买方"} text2={consigneeAdd.name} variant={"equal"}/>
