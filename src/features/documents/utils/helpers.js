...
export function InfoBox(label, value) {
    ...
    return <Box height="100%" border={1} borderColor="grey.main">
        <Typography component="div" className={classes.box} variant="caption" style={{ wordWrap: "break-word" }}>
            <Box fontWeight="fontWeightBold" lineHeight={1.2} className={classes.tableBox}>
                {label}
            </Box></Typography>
        <Typography component="div" display="inline" className={classes.box} style={{ wordWrap: "break-word" }}>
...
export function InfoBoxLong(label1, value1, label2, value2) {
    ...
    return <Grid container>
        ...
        <Grid item xs={3}>
            <Box height="100%" border={1} borderColor="grey.main">
                <Typography component="div" display="inline" className={classes.box} variant="caption" style={{ wordWrap: "break-word" }}>
                    {value1}
                </Typography>
            </Box>
        </Grid>
